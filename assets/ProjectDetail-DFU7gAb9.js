import{u as U,i as b,d as y,r as v,c as a,h,a as e,t as i,n as B,o as l,g as w,w as E,j as o,e as L,k as T,b as c,F as f,f as j}from"./index-DS2pgFif.js";import{p as A}from"./projects-D6p4dtM2.js";function C(){const u=U(),t=b(()=>Number(u.params.id));return b(()=>A.find(s=>s.id===t.value))}const M=y({__name:"CodeBlock",props:{code:{},styleArray:{default:()=>[]}},setup(u){const t=u,d=v(t.styleArray);return(s,n)=>(l(),a("pre",{class:"code-block",style:B(d.value)},[n[0]||(n[0]=h("        ")),e("code",null,i(t.code)+" ",1),n[1]||(n[1]=h(`
